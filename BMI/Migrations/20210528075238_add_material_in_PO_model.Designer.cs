...
namespace BMI.Migrations
{
    ...
    [Migration("20210528075238_add_material_in_PO_model")]
    partial class add_material_in_PO_model
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BMI.Models.QtyLine1Input", b =>
                {
                    ...
                    b.Property<string>("id_dateVessel")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("BMI.Models.QtyLine1Output", b =>
                {
                    ...
                    b.Property<string>("datevesselmodelid")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("BMI.Models.RmPlantDetailModel", b =>
                {
                    b.Property<string>("id_rmmowidetail")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("id_rmmowidetail");

                    b.HasIndex("refference");

                    b.HasIndex("sap_code");

                    b.ToTable("Rm_plant_detail");
                });

            modelBuilder.Entity("BMI.Models.RmPlantModel", b =>
                {
                    b.Property<string>("refference")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("BMI.Models.DateVesselModel", b =>
                {
                    b.HasOne("BMI.Models.RmPlantModel", "RmPlantModel")
                        .WithMany()
            ...
            modelBuilder.Entity("BMI.Models.RmPlantDetailModel", b =>
                {
                    b.HasOne("BMI.Models.RmPlantModel", "RMMOWIModel")
                        .WithMany()
                        .HasForeignKey("refference");
