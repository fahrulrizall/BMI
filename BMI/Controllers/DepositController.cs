...
namespace BMI.Controllers
{
    public class DepositController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            //    {
            //        status = a.Key,
            //        total_qty = Convert.ToDouble( a.Sum(k => k.qty_pl) - _db.Production_input.Sum(k => k.qty) - _db.AdjustmentFG.Sum(k => k.qty)),
            ...
            //var fg = _db.Production_output.Sum(k => k.qty) - _db.Shipment_detail.Sum(k => k.qty * k.MasterBMIModel.lbs *2.204) - _db.AdjustmentFG.Sum(k => k.qty * k.MasterBMIModel.lbs/2.204);
            return View();
        }
    }
}
